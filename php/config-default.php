...
$CALLOUT_CODES_LOOKUP = array(
        ...
        // New for 2017 in RDDFG
        "AIRCR" => "Aircraft Crash",
        "AIREL" => "Aircraft Emergency Landing",
        "AIRF" => "Aircraft Fire",
        "AIRSB" => "Aircraft Standby",
        "ASSIST" => "Assist - General public or other agency assistance. Not a lift assist call.",
        "BBQF" => "Barbeque Fire",
        "BOMB" => "Bomb Threat",
        "BURN" => "Burning Complaint",
        "CARBM" => "Carbon Monoxide Alarm",
        "CHIMF" => "Chimney Fire",
        "CONTF" => "Container/Sea-Can or Pressurized Vessel Fire",
        "DUMP" => "Dumpster",
        "ELECF" => "Electrical Fire",
        "ELECFSUB" => "Electrical Fire – Substation",
        "EXP" => "Explosion",
        "FALRMC" => "Fire Alarms – Commercial",
        "FALRMF" => "Fire Alarms – False",
        "FALRMR" => "Fire Alarms – Residential",
        "FLOOD" => "Flooding",
        "HAZNG" => "Hazmat – Natural Gas",
        "HAZODOUR" => "Hazmat – Odour",
        "HAZSPILL" => "Hazmat – Spill",
        "HAZVAPOUR" => "Hazmat – Vapour",
        "HAZCONF" => "Hazmat – CONFIRMED",
        "HAZUNCON" => "Hazmat – UNCONFIRMED",
        "WIRES" => "Hydro Lines Down",
        "ITEM" => "Item Fire",
        "KITCHENF" => "Kitchen Item Fire",
        "LIFTEMG" => "Lift Assist – Emergency",
        "LIFTR" => "Lift Assist – Routine",
        "LIFTPUB" => "Lift Assist – Public",
        "MED" => "Medical Aid",
        "MEDR" => "Medical Aid - BCAS Routine",
        "MEDFIRE" => "Medical Emergency/Fire Emergency",
        "MEDHAZ" => "Medical Emergency/Hazmat Emergency",
        "MVIMIN" => "MVI - Minor",
        "MVISER" => "MVI – Serious",
        "MVIPED" => "MVI - Pedestrian",
        "OPEN" => "Open Air Fire",
        "RESCCON" => "Rescue - Confined Space",
        "RESCHIGH" => "Rescue - High Angle",
        "RESCICE" => "Rescue – Ice",
        "RESCIND" => "Rescue – Industrial",
        "RESCMED" => "Rescue - Medical",
        "RESC" => "Rescue – Other",
        "RESCWTR" => "Rescue – Water",
        "SHIPD" => "Ship/Boat Fire - At Dock",
        "SHIPU" => "Ship/Boat Fire – Underway",
        "SMOKIN" => "Smoke Report – Inside",
        "STRCOLL" => "Structure Collapse",
        "STROUT" => "Structure Fire – Outbuilding",
        "STRRES" => "Structure Fire – Residential",
        "STRCOM" => "Structure Fire – Commercial/High Hazard",
        "STRHIGH" => "Structure Fire – High Life/Multi-Family",
        "STRRECALL" => "Structure Fire – Recall",
        "TRANS" => "Transformer/Pole Fire",
        "VEHF" => "Vehicle Fire",
        "WILDINT" => "Wildland – Interface",
        "WILD2" => "Wildland – Large (Rank 4-6)",
        "WILD1" => "Wildland – Small (Rank 1-3)",
        "HANG" => "911 Hang Up",
        "FOCC" => "Admin Call Records",
        "AMBUL" => "Ambulance – Notification",
        "CITY" => "City – Notification",
        "DISPTEST" => "Dispatcher Test",
