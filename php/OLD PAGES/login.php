...
<html>
    ...
    <body>
    	...
    	<?php if ($detect->isMobile()) echo "<b>Mobile Device Detected! login.php</b>"; ?>
    	<?php if ($detect->isTablet()) echo "<b>Tablet Device Detected! login.php</b>"; ?>
    	<?php if ($detect->isMobile() == false && $detect->isTablet() == false) echo "<b>Computer Device Detected! login.php</b>"; ?>
