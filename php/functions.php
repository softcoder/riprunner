...
function getCallStatusDisplayText($dbStatus) {
	...
	switch($dbStatus) {
		...
		case CalloutStatusType::Notified:
			$result = 'notified';
			break;
		case CalloutStatusType::RESPOND_OPT_2:
			$result = RESPOND_OPT_2;
			break;
		case CalloutStatusType::RESPOND_OPT_4:
		    $result = RESPOND_OPT_4;
		    break;			
	    case CalloutStatusType::RESPOND_OPT_5:
	        $result = RESPOND_OPT_5;
	        break;
        case CalloutStatusType::RESPOND_OPT_6:
            $result = RESPOND_OPT_6;
            break;
        case CalloutStatusType::RESPOND_OPT_7:
            $result = RESPOND_OPT_7;
            break;
        case CalloutStatusType::RESPOND_OPT_8:
            $result = RESPOND_OPT_8;
            break;
        case CalloutStatusType::RESPOND_OPT_9:
            $result = RESPOND_OPT_9;
            break;
